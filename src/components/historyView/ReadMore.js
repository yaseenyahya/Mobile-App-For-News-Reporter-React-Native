...
import {getTextByChildren, insertAt, linesToCharacters} from './readmorehelper.js';
...
const ReadMore = ({
  ...
  onSeeMore: onSeeMoreBlocked = undefined,
  onSeeLess: onSeeLessBlocked = undefined,
  debug = false,
  collapsed: externalCollapsed = undefined,
  collapsedCallbackReturn,
  ...restProps
}) => {
  ...
  const log = useCallback(logClosure(debug), [true]);
