...
const IS_IPHONEX = conf.isIphoneX;

const IPHONE_INSET_TOP = conf.Inset.portrait.topInset;
const IPHONE_INSET_TOP_LANDSCAPE = conf.Inset.landscape.topInset;

const IPHONE_INSET_BOTTOM = conf.Inset.portrait.bottomInset;
const IPHONE_INSET_BOTTOM_LANDSCAPE = conf.Inset.landscape.bottomInset;
