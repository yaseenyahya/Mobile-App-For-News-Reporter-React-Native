...
export default class Dropdown extends PureComponent {
  ...
  onPress(event) {
    ...
    this.container.measureInWindow((x, y, containerWidth, containerHeight) => {
      ...
      let top = y + dropdownOffset.top - itemPadding + 50;
  ...
  renderBase(props) {
    ...
    return (
      ...
      ref={(ref) => this.textFieldRef = ref}
        ...
        inputContainerStyle={{padding:0,height:50,margin:0}}
        labelTextStyle={{ fontWeight: "700" }}
        style={[{ fontWeight: "700",flex:1 }, this.props.style]}
        label={value == null || value == undefined? this.props.label : title}
  ...
  renderRipple() {
    ...
    let style = {
      ...insets,
      fontWeight: "700",
      height: this.itemSize() +20 + bottom,
      position: "absolute"
    };
  ...
  _validate = () => {
    ...
    let haveError = this.state.value == undefined;
    this.setState({ haveError });
    return !haveError;
    }{
      return true;
    }
  ...
  renderAccessory() {
    ...
    return (
      <View style={styles.accessory}>
        ...
        {this.state.haveError && !this.props.hiddenIconErrorView ? (
          <Icon
            active
            style={{
              color: this.props.backgroundColorErrorView,
              fontSize: 18,
              marginLeft: 5
            }}
            name="md-alert"
